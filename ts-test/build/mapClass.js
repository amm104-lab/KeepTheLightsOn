    ...
    white() {
        if (this.user.getNorth()) {
            return [m("div", { class: "white" }, [m("button", { class: "door",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("white"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "white" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("darkPurple"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("white"); } }, "Turn North"))];
        }
    }
    black() {
        if (this.user.getNorth()) {
            return [m("div", { class: "black" }, m("button", { class: "lockedDoor",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("black"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "black" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("red"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("black"); } }, "Turn North"))];
        }
    }
    blackNoKey() {
        return [m("div", { class: "black" }, m("button", { class: "lockedDoor",
    ...
    blackToolSet() {
        return [m("div", { class: "black" }, m("button", { class: "lockedDoor" }, "-")),
            m("div", { class: "toolBox" }, [
                ...
                m("div", { class: "buttonBox" }, m("button", { class: "choice", onclick: () => { this.user.goThroughDoor("goodEnd"); } }, "Yes"), m("button", { class: "choice", onclick: () => {
    ...
    blue() {
        if (this.user.getNorth()) {
            return [m("div", { class: "blue" }, m("button", { class: "door",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("blue"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "blue" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("lightBlue"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("blue"); } }, "Turn North"))];
        }
    }
    lightBlue() {
        if (this.user.getNorth()) {
            return [m("div", { class: "lightBlue" }, [m("button", { class: "door",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightBlue"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "lightBlue" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("white"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightBlue"); } }, "Turn North"))];
        }
    }
    darkBlue() {
        if (this.user.getNorth()) {
            if (this.user.getKey()) {
                return m("div", { class: "darkBlue" }, m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkBlue"); } }, "Turn South"));
            }
            else {
                return [
                    ...
                    m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkBlue"); } }, "Turn South"))
                ];
            }
        }
        else {
            return [m("div", { class: "darkBlue" }, [
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkBlue"); } }, "Turn North"))];
        }
    }
    darkBlueObtained() {
    ...
    red() {
        if (this.user.getNorth()) {
            return [m("div", { class: "red" }, [m("button", { class: "door",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("red"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "red" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("lightRed"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("red"); } }, "Turn North"))];
        }
    }
    lightRed() {
        if (this.user.getNorth()) {
            return [m("div", { class: "lightRed" }, [m("button", { class: "door",
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightRed"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "lightRed" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("white"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightRed"); } }, "Turn North"))];
        }
    }
    darkRed() {
        let text;
        ...
        if (this.user.getNorth()) {
            return [m("div", { class: "darkRed" }, m("button", { class: "switch", onclick: () => {
                        root.setAttribute("ID", "lightsOff");
                        this.user.goThroughDoor("darkness");
                    } }, ""), text),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkRed"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "darkRed" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("black"); } })),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkRed"); } }, "Turn North"))];
        }
    }
    purple() {
        if (this.user.getNorth()) {
            return [m("div", { class: "purple" }, [m("button", { class: "door",
                    ...
                    m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("darkBlue"); } }, "-")]),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("purple"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "purple" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("lightBlue"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("purple"); } }, "Turn North"))];
        }
    }
    lightPurple() {
        if (this.user.getNorth()) {
            return [m("div", { class: "lightPurple" }, [m("button", { class: "door",
                    ...
                    m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("darkPurple"); } }, "-")]),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightPurple"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "lightPurple" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("lightRed"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("lightPurple"); } }, "Turn North"))];
        }
    }
    darkPurple() {
        if (this.user.getNorth()) {
            return [m("div", { class: "darkPurple" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("white"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkPurple"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "darkPurple" }, [m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("purple"); } }, "-"),
                ...
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("darkPurple"); } }, "Turn North"))];
        }
    }
    yellow() {
        if (this.user.getNorth()) {
            return [m("div", { class: "yellow" }, [m("button", { class: "door",
                    ...
                    m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("darkPurple"); } }, "-")]),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("yellow"); } }, "Turn South"))];
        }
        else {
            return [m("div", { class: "yellow" }, [m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("lightPurple"); } }, "-"),
                    m("button", { class: "door",
                        onclick: () => { this.user.goThroughDoor("red"); } }, "-")]),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("yellow"); } }, "Turn North"))];
        }
    }
    orange() {
        if (this.user.getNorth()) {
            if (this.user.getOil()) {
                return [m("div", { class: "orange" }, m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("orange"); } }, "Turn South")),
                ...
                return [m("div", { class: "orange" }, [
                    ...
                    m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("orange"); } }, "Turn South"))];
            }
        }
        else {
            return [m("div", { class: "orange" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("yellow"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("orange"); } }, "Turn North"))];
        }
    }
    orangeObtained() {
        return [m("div", { class: "orange" }, [
    ...
    green() {
        if (this.user.getNorth()) {
            if (this.user.getToolKit()) {
                return m("div", { class: "green" }, m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("green"); } }, "Turn South"));
            }
            else {
                return [m("div", { class: "green" }, [
                    ...
                    m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("green"); } }, "Turn South"))];
            }
        }
        else {
            return [m("div", { class: "green" }, m("button", { class: "door",
                    onclick: () => { this.user.goThroughDoor("orange"); } }, "-")),
                m("div", m("button", { class: "turn", onclick: () => { this.user.turnAroundTo("green"); } }, "Turn North"))];
        }
    }
    greenObtained() {
        return [m("div", { class: "green" }, [
